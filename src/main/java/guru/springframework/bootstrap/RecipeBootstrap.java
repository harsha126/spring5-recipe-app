...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public void onApplicationEvent(ContextRefreshedEvent contextRefreshedEvent) {
        log.debug("hello from bootstrap class");
    ...
    private List<Recipe> getRecipies(){
        ...
        Optional<UnitOfMeasure> tableSpoonlUOMoptional = unitOfMeasureRepository.findByDescription("Tablespoon");
        if(!tableSpoonlUOMoptional.isPresent()){
            throw new RuntimeException("Expected UOM Not Found");
        }
        ...
        UnitOfMeasure tablespoonUom = tableSpoonlUOMoptional.get();
